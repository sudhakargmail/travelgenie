...
APIKEY = "P8lFbK9vTMPwKN7KJiteH0yK3ykgJVRz" # API Key provided for your account, to identify you for API access
IMAGIX_SIGN_KEY = 'JfoywHHgIsUOrlPb'

MAX_RESULTS = 2  # maximum number of results to show in chat
